<?php
   ...
   Description: Easily add a Facebook Like Box to your site using a widget. [FR] : Ajoutez une Facebook Like Box &agrave; votre site gr&acirc;ce &agrave; un widget. 
   ...
   */
    ...
    */
    ...
    define('FACEBOOK_ZAMABLOG_VERSION', '1.0');
...
function fctWidgetFacebookZamablogControl(){
  ...
  $strTarnsTitle = __( "Title", "zamablogfacebook") ;
    ...
    $strTarnsShowHeader = __( "Show hearder", "zamablogfacebook") ;
